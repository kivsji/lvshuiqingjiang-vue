...
export default [
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/coupons/couponsList.vue")
          },
          {
            path: "couponsRecords",
            name: "couponsRecords",
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/coupons/couponsRecords.vue")
          }
        ],
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/active/lotteryActive.vue")
          },
          {
            path: "customActive",
            name: "customActive",
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/active/activeDetail.vue")
          },
          {
            path: "activeShare",
            name: "activeShare",
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/active/activeShare.vue")
          }
        ],
        component: () =>
          import("@/view/lvshuiqingjiang/active/activeManage.vue")
      },
      {
        path: "vip",
        name: "vip",
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/shop/shopDefail.vue")
          },
          {
            path: "/shopSwipe",
            name: "shopSwipe",
        ...
        children: [
          {
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/ticket/ticketList.vue")
          },
          {
            path: "/ticketOrder",
            name: "ticketOrder",
            ...
            component: () =>
              import("@/view/lvshuiqingjiang/ticket/ticketOrder.vue")
          }
        ],
      ...
      //         },
      //         component: () =>
      //           import("@/view/lvshuiqingjiang/order/orderList.vue")
      //       }
      //     ]
      //   }
    ]
