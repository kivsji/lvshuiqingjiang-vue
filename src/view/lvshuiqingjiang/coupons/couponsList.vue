<template>
    <div>
        ...
        <Modal
            ...
            style="width:500px;"
            title='奖券设置'
            @on-ok="inputCouponsData"
            @on-cancel="cancleDara(false)"
            :mask-closable="false"
        >
            ...
            <row style="margin-top:20px;">
                ...
                <i-col span='18'>
                    <InputNumber
                        :min="0"
                        v-model="couponsData.receive_num"
                    ></InputNumber>
                </i-col>
            </row>
            <row style="margin-top:20px;">
            ...
            >
                ...
                <i-col span='18'>
                    <InputNumber
                        :min="0"
                        v-model="couponsData.time_limit"
                    ></InputNumber>
                </i-col>
            </row>
...
export default {
                            ...
                            h(
                                "Button",
                                {
                                    ...
                                    nativeOn: {
                                        click: () => {
                                            this.isNew = false;
                                            this.couponsData = this.couponsData = {
    ...
    methods: {
        ...
        inputCouponsData() {
            if (
                this.couponsData.name === "" ||
                this.couponsData.thumb === "" ||
                this.couponsData.desc === ""
            ) {
